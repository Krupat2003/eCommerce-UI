    ...
    return (
        <div className="bg-black1 h-screen flex justify-center items-center">
            <form className="bg-black2 p-5 w-10/12 sm:w-8/12 md:w-6/12 lg:w-4/12 rounded"
                ...
                <div className="mb-4">
                    <input type="password" name="password" onChange={handleInputs} value={state.password} className="w-full bg-black p-4 rounded outline-none text-white" placeholder="Enter password..." />
                </div>
                <div className="mb-4" >
